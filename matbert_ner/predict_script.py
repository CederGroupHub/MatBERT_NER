...
predict(data, True, model, solid_state_state, predict_path='{}/{}'.format(solid_state_state, 'predict_doping_solid_state_169828.pt'), device='gpu:0')
predict(data, True, model, doping_state, predict_path='{}/{}'.format(doping_state, 'predict_doping_doping_169828.pt'), device='gpu:0')
