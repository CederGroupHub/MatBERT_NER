...
class NERModel(ABC):
    ...
    def __init__(self, modelname="allenai/scibert_scivocab_cased", classes = ["O"], tag_format='IOB2', crf_penalties=False, device="cpu", lr=5e-5, results_file=None):
