...
for model_name in model_names:
    for data in data_names:
        for seed in seeds:
            ...
            configs = {'_{}_full_crf_{}_{}_{}'.format(data, tag_scheme.lower(), seed, split): {'full_finetuning': True, 'format': tag_scheme, 'split': [split/100, split/800, 0.1]} for split in splits for tag_scheme in tag_schemes}
